...
for i in range(len(x) - 1):
    if i % 3 == 0:
        ...
        x590.append(x[i])
        raw_intensity590.append(raw_intensity[i])
...
raw_intensity590 = raw_intensity590[:(limit-1)]
...
sigma590 = np.std(raw_intensity590)
mu590 = np.average(raw_intensity590)
intensity590 = raw_intensity590 - mu590
intsneity590 = intensity590/sigma590


raw_intensity470 = np.asarray(raw_intensity470)
raw_intensity405 = np.asarray(raw_intensity405)
raw_intensity590 = np.asarray(raw_intensity590)
...
data = {
    ...
    'Time (s)': t590,
    '590nm Normalized Light Intensity':intensity590,
    'Time (s)':t470,
